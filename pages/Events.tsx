...
import { Calendar, MapPin, ArrowRight, History, Zap, Filter, X, Info, ExternalLink, User, Mail } from 'lucide-react';
...
const Events: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 transition-colors duration-500">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto font-medium leading-relaxed">
            From technical deep-dives to industry mixers, discover events designed to accelerate your data science journey.
          </p>
        </div>
      </section>
      ...
      {/* Past Events Section (Timeline Style) */}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-950/80 backdrop-blur-xl animate-in fade-in duration-300">
          <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 ring-1 ring-slate-200 dark:ring-slate-800">
            ...
            <div className="relative aspect-video">
              ...
              <button 
                onClick={closeModal}
                className="absolute top-6 right-6 p-2.5 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-full text-white transition-all active:scale-90"
              >
                <X className="w-6 h-6" />
              </button>
              <div className="absolute bottom-8 left-8 right-8">
                <span className="px-3 py-1 bg-indigo-600 text-white text-[10px] font-black rounded-full uppercase tracking-widest mb-3 inline-block">
            ...
            <div className="p-8 sm:p-12">
              <div className="grid grid-cols-2 gap-8 mb-10">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-900 dark:text-slate-200">{selectedEvent.date}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="p-2.5 bg-slate-100 dark:bg-slate-800 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-900 dark:text-slate-200">Remote Lab</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                  ...
                  {" "}This event is designed for students looking to deepen their practical knowledge in data science. You will engage with peers, work through challenging scenarios, and leave with actionable insights. Participants will have access to high-quality datasets and mentorship from industry professionals.
                </p>
              </div>
              ...
              <div className="mt-12 flex flex-col sm:flex-row gap-4">
                <button 
                  ...
                  className="flex-1 px-8 py-5 bg-indigo-600 hover:bg-indigo-500 text-white font-black rounded-2xl shadow-xl shadow-indigo-600/20 transition-all active:scale-95 flex items-center justify-center gap-2"
                >
                  START REGISTRATION
                  <ArrowRight className="w-4 h-4" />
                </button>
                <button 
                  onClick={closeModal}
                  className="px-8 py-5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 font-black rounded-2xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-all active:scale-95"
                >
                  NOT NOW
                </button>
              </div>
          ...
          <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 ring-1 ring-slate-200 dark:ring-slate-800">
            <div className="p-8 sm:p-12">
              <div className="flex justify-between items-start mb-8">
                <div>
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-100 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-[10px] font-black rounded-full uppercase tracking-widest mb-4">
                    Registration
                  </div>
                ...
                <button 
                  onClick={closeModal}
                  className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-full text-slate-400 transition-all active:scale-90"
                >
                  <X className="w-6 h-6" />
                </button>
              </div>
              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-11 pr-4 py-4 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all font-medium"
                    />
                  </div>
                </div>
                ...
                <div className="pt-6">
                  <button 
                    ...
                    className="w-full px-8 py-5 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white font-black rounded-2xl shadow-xl shadow-indigo-600/20 transition-all active:scale-95 flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
      ...
      <section className="py-24 bg-indigo-600 text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 px-4">
          <h2 className="text-4xl md:text-5xl font-black mb-8">Have an idea for an event?</h2>
          <p className="text-indigo-100 text-lg mb-12 max-w-xl mx-auto font-medium">
            We're always looking for community leads to host workshops and project sprints.
          </p>
